...
public class SequenceGeneratorSource extends RichParallelSourceFunction<Event>
    ...
    public void initializeState(FunctionInitializationContext context) throws Exception {
        final TaskInfo runtimeContext = getRuntimeContext().getTaskInfo();
    ...
    public static SequenceGeneratorSource createSourceFromParameters(ParameterTool pt) {
        return new SequenceGeneratorSource(
                pt.getInt("keyspace", 1000000),
                pt.getInt("payload_size", 1000),
                0L,
                100L,
                0L,
                0L
    ...
    public static BoundedOutOfOrdernessTimestampExtractor<Event> createTimestampExtractor(
            ParameterTool pt) {
